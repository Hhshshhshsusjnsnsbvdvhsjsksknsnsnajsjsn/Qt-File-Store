...
DB_NAME = environ.get("DB_NAME", "qtmovie99")
...
# Channel Information
LOG_CHANNEL = int(environ.get("LOG_CHANNEL", "-1002152890993"))
...
PUBLIC_FILE_STORE = is_disable((environ.get('PUBLIC_FILE_STORE', "Ture")), True)
